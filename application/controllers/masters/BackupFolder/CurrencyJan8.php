...
class Currency extends MY_Controller {
	...
	{  
		if($this->require_min_level(1))
        {
			...
			$this->table->set_heading('Operation','Name','Symbol','Status','Created By','Created On','Updated By','Updated On'); 
	...
	function datatable()
    {
    	$this->datatables->select('b.cur_id, b.cur_name,b.currency,b.cur_status, u.username, b.cur_created_on,v.username AS s,b.cur_updated_on','u.username')
