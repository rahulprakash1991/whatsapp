...
class Purchaseorder extends CI_Model
{
	...
	{
		$this->db->select('p.sl_no,p.qty,p.unit_price,p.item_description, p.item_description_arabic,p.uniteng')
	...
	public function find_qus_draft_number($id)
	{
	  $quotation_no = $this->db->select_max('quotation_no')->where('quo_id',$id )->limit(1)->get('quotation')->row('quotation_no');
    	return $quotation_no;
	}
	public function find_qus_status1($id)
	{
	  $qus_status = $this->db->select_max('qus_status')->where('quo_id',$id )->limit(1)->get('quotation')->row('qus_status');
    	return $qus_status;
	}
	public function find_qus_rev_number($id)
	{
	  $qus_rev = $this->db->select_max('qus_rev')->where('quo_id',$id )->limit(1)->get('quotation')->row('qus_rev');
    	return $qus_rev;
	}
	//28-2-2022
	function getClientNum()
    {
        ...
        return $pre['client_number'];
    }
    function getClientPrifix()
    {
        $pr = $this->db->get("tbl_preferences")->result();
        ...
        return $pre['client_prefix'];
    }
     function getVendorNum()
    {
        $pr = $this->db->get("tbl_preferences")->result();
        ...
        return $pre['vendor_number'];
    } 
    function getVendorPrifix()
    {
        $pr = $this->db->get("tbl_preferences")->result();
        ...
        return $pre['vendor_prefix'];
    }
    public function find_enquiry_client_num($id)
	{
	  $client_id = $this->db->select_max('client_id')->where('id',$id )->limit(1)->get('tbl_enquiry')->row('client_id');
    	return $client_id;
	}
	public function find_enquiry_client_rep_id($id)
	{
	  $client_rep_id = $this->db->select_max('client_rep_id')->where('id',$id )->limit(1)->get('tbl_enquiry')->row('client_rep_id');
    	return $client_rep_id;
	}
	public function find_enquiry_reff($id)
	{
	  $enq_ref = $this->db->select_max('enq_ref')->where('id',$id )->limit(1)->get('tbl_enquiry')->row('enq_ref');
    	return $enq_ref;
	}
	//March 10
	 function getEnqNum()
    {
        ...
        return $pre['enq_number'];
    }
     function getEnqPrifix()
    {
        $pr = $this->db->get("tbl_preferences")->result();
        ...
        return $pre['enq_prifix'];
    }
     function getEnqSuffix()
    {
        $pr = $this->db->get("tbl_preferences")->result();
