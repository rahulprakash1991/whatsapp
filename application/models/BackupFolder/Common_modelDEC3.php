...
class Common_model extends CI_Model
{
	...
	*/
	...
	{
		$this->db->select('c.c_id, c.c_logo, c.c_org_name, c.c_street, c.c_area, c.c_city, c.c_state, c.c_pincode, c.c_country, c.c_phone, c.c_mobile, c.c_fax, c.c_website, c.c_email, cr.cur_name, cr.cur_symbol, c.c_tax, c.c_cst');
		$this->db->from('tbl_company_profile c');
		$this->db->where('c_id', $company_id);
		$this->db->join('tbl_currency cr', 'cr.cur_id = c.c_currency');
		return $this->db->get();
	}
