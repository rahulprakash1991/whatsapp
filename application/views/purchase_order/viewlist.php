					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-white">
								...
								<form  method="POST" action="<?php echo base_url();?>Purchase_order/manage"> 
									<div class="col-md-2">
									...
									<div class="col-md-2">
									<div class="form-group <?PHP if(form_error('rec_status')){ echo 'has-error';} ?>">
										<label>PO Status</label>
											<select name="rec_status" id="rec_status" class="form-control" >
												<option value="">-- Select --</option>
                                           		<option value="1" <?php if($rec_status== '1'){ echo "selected";}?>> Pending</option>
                                            	<option value="2" <?php if($rec_status== '2'){ echo "selected";}?>>Completed </option>
                                              	<option value="0" <?php if($rec_status== '0'){ echo "selected";}?>> new</option>
											</select>										
                                    </div>
								</div>
								<div class="col-md-2">
