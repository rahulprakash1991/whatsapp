...
<table width="100%" cellspacing="5" cellpadding="5" border="1" rules="all">
  <thead>
    <tr>
      ...
      <th style="width:10%;" style="text-align : right;">Cost Price<br>(<?php echo $getCurrency;?>)</th>
      <th style="width:10%;" style="text-align : right;">Total Cost Value <br>(<?php echo $getCurrency;?>)</th>           
      <th style="width:10%;" style="text-align : right;">Selling Price<br>(<?php echo $getCurrency;?>)</th>
      <th style="width:10%;" style="text-align : right;">Total Selling Value<br>(<?php echo $getCurrency;?>)</th>
