...
<div class="page-inner">
				...
				<div class="col-md-12">
					<div class="panel panel-white">
						...
						<div class="panel-body">
							<div class="row">
							<form  method="POST" action="<?php echo base_url();?>Report/vendor_balance_sheet"> 
	...
	<div class="panel panel-info" id='po_details'>                		
         <div class="panel-body" >
            ...
            <a href="<?php echo base_url();?>Report/vendor_balance_sheet_print" target="_blank"  class="btn btn-success pull-right"><i class="fa fa-file-excel-o"></i> Export To Excel</a>
			<a href="<?php echo base_url();?>Report/vendor_balance_sheet_print/print" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>                               
                <thead>                                            
                    <tr>
                        <th>S.No</th>
                        <th>Date</th>
