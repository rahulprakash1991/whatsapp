<div class="page-inner">
	...
	<div class="panel panel-info" id='po_details'>                		
         <div class="panel-body" >
            ...
            <a href="<?php echo base_url(); ?>Report/outstanding_payable_export" target="_blank"  class="btn btn-success pull-right"><i class="fa fa-file-excel-o"></i> Export To Excel</a>
			<a href="<?php echo base_url(); ?>Report/outstanding_payable_export/print" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>                 
                <thead>                                            
                    <tr>
                        <th>S.No</th>
                        <th>Vendor Name</th>
