				...
				<div class="col-md-12">
					<div class="panel panel-white">
						<div class="panel-body">
							<div class="row">
							<form  method="POST" action="<?php echo base_url();?>Report/SalesReport"> 
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="form-group <?PHP if(form_error('vendor_id')){ echo 'has-error';} ?>">
										<label>Client<span1></span1></label>
											<?php 
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="panel-body" >
									...
									<a href="<?php base_url();?>export_excel_sales" target="_blank"  class="btn btn-success pull-right"><i class="fa fa-file-excel-o"></i> Export To Excel</a>

									<a href="<?php base_url();?>export_excel_sales/print" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>
