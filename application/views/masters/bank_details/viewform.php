                                        ...
                                        <div class="row">   
                                            <div class="col-md-3">
                                                <div class="form-group <?PHP if(form_error('ifs_code')){ echo 'has-error';} ?>">
                                                    <label>IBAN No </label>
                                                     <input type="text" autocomplete="off" class="form-control"  placeholder="Enter IBAN NO" id="ifs_code" name="ifs_code" value="<?php echo $ifs_code; ?>">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group <?PHP if(form_error('micr_no')){ echo 'has-error';} ?>">
                                                    <label>SWIFT Code </label>
                                                     <input type="text" autocomplete="off" class="form-control"  placeholder="Enter SWIFT Code" id="micr_no" name="micr_no" value="<?php echo $micr_no; ?>">
                                          ...
                                          <!--    <div class="col-md-3">
                                             ...
                                             <div class="col-md-3">
                                                <div class="form-group <?PHP if(form_error('bank_status')){ echo 'has-error';} ?>">
                                                   ...
                                                   <div class="col-md-3">
                                           <div class="form-group <?PHP if(form_error('bank_curency')){ echo 'has-error';} ?>">
                                                <label><?php echo 'Currency';?></label>
                                                <?php
                                          $attrib = 'class="bootstrap-select" data-live-search="true" data-width="100%" id="bank_curency"  ';
                          echo form_dropdown('bank_curency', $drop_menu_currency, set_value('bank_curency', (isset($bank_curency)) ? $bank_curency : ''), $attrib);
                        ?>
                                            
                                                 <label class="error"><?php echo form_error('bank_curency'); ?></label>
                                            </div>
                                        </div>
                                        </div>
                                      <!--   <div class="row">
