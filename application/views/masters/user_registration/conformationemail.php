...
.fa {
  ...
  transform: translate(0, 0);
	...
	<body>
						...
						UserId	:	<?php echo $use_name;?><br>
						Password 	:	<?php echo $sys_pass;?><br>
			...
			<p><b>Notes: </b></p>
			<p>
				1.	You must keep your password confidential and that you do not grant permission to any person to use your User ID and password.<br>
2.	The assigned password can only be used ONCE. Please change your password upon receipt of this email. <br>
3.	Your password must have the following characteristics:<br>
i.	At least Eight characters<br>
ii. at least One Uppercase char (A to Z)<br>
iii. at least One Lowercase char (a to z)<br>
iv	at least One Number (0 to 9)<br>
4.	Ensure your terminal is not left unattended after you have signed on to the system.<br>
5.	If your USER ID is not used for more than 30 days, it will be “Locked” by the system automatically.<br>
			</p>
			<hr>
			<p><b>Regards,</b><br>
<?php echo $c_org_name;?>
