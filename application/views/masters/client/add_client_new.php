...
if(isset($value) && !empty($value))
{
    ...
    foreach($value->result() as $row)
    {
        ...
        $po_box_arabic = $row->client_area1; 
        $city_arabic = $row->client_city1; 
        $state_arabic = $row->client_state1; 
        $zip_arabic = $row->client_zip1; 
        $country_arabic= $row->client_country1; 
        ...
        $client_bank = $row->client_bank;
        $client_curency = $row->client_curency;
...
foreach($evalue as $key =>$row)
  {
    ...
    $scr_no[$key]     = $row->client_cr_no;
    $sclient_no[$key] = $row->client_vat_no;
    $saddress1[$key]  = $row->client_address;
    $sstreet[$key]    = $row->client_street;
    $sarea[$key]      = $row->area;
    $scity[$key]      = $row->city;
    ...
    $sclient_vat_arabic[$key] = $row->client_vat_no_arabic;
    $scr_no_arabic[$key]      =$row->client_cr_no_arabic;
    $saddress11[$key]         = $row->client_address_arabic;
    $sstreet_arabic[$key]     = $row->client_street_arabic;
...
?>
                                         ...
                                         <div class="col-md-3">
                                              ...
                                              <div class="form-group <?PHP if(form_error('client_ab')){ echo 'has-error';} ?>">
                                                <label><?php echo $this->lang->line('client_ab')?><span1>*</span1></label>
                                                    ...
                                                    <input type="text" autocomplete="off" class="form-control"  placeholder="<?php echo $this->lang->line('client_ab');?>" id="client_ab" name="client_ab" value="<?php echo $client_ab; ?>"  >
                                      ...
                                      <div class="row" >
                                         <div class="col-md-6" style="text-align: right;">
                                          <div class="form-group <?PHP if(form_error('client_arabic_name')){ echo 'has-error';} ?>">
                                                ...
                                                <label><?php echo $this->lang->line('client_name_arabic')?></label>

                                                 <input type="text" name="client_arabic_name" dir="rtl" class="form-control" placeholder="Client Name (Arabic)"  value="<?php echo $client_arabic_name;?>" >
                                        ...
                                        <div class="col-md-3">
                                         <div class="form-group <?PHP if(form_error('client_bank')){ echo 'has-error';} ?>">
                                                <label><?php echo 'Client Bank';?></label>
                                                <?php 
                                          ...
                                          <input type="text" class="form-control" name="fax" autocomplete="off" id="fax" placeholder="Fax" value="<?php echo $fax;?>">
                                           ...
                                           <div class="form-group <?php if(form_error('contact_no')){ echo 'has-error'; }?>">
                                            ...
                                            <label id="location-error" class="validation-error-label" for="location"><?php echo form_error('email'); ?></label>
                                              ...
                                              <div class="row">
                                               <div class="col-md-4">
                                           <div class="form-group <?PHP if(form_error('client_curency')){ echo 'has-error';} ?>">
                                                <label><?php echo 'Currency';?></label>
                                                <?php
                                          $attrib = 'class="bootstrap-select" data-live-search="true" data-width="100%" id="client_curency"  ';
                          echo form_dropdown('client_curency', $drop_menu_currency, set_value('client_curency', (isset($client_curency)) ? $client_curency : ''), $attrib);
                        ?>
                                            
                                                 <label class="error"><?php echo form_error('client_curency'); ?></label>
                                            </div>
                                        </div>
                                            </div>
                                      </fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group <?PHP if(form_error('vendor_no1')){ echo 'has-error';} ?>">
                                                 ...
                                                 <input type="text"  dir="rtl" autocomplete="off" class="form-control"  placeholder="VAT Number (Arabic)" id="vendor_no1" name="vendor_no1" value="<?php echo $client_vat_arabic; ?>">
                                      ...
                                      <!-- <legend><?php echo $this->lang->line('client_address_english')?></legend> -->
                                          <div class="row">
                                           ...
                                           <div class="col-md-4">
                                            <div class="form-group <?PHP if(form_error('svendor_no['.$i.']')){ echo 'has-error';} ?>">
                                                 ...
                                                 <input type="text" autocomplete="off" class="form-control"  placeholder="<?php echo $this->lang->line('client_vendor_no');?>" id="svendor_no<?php echo $i;?>" name="svendor_no[]" value="<?php echo $sclient_no[$i]; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group <?PHP if(form_error('svendor_no1['.$i.']')){ echo 'has-error';} ?>">
                                                 ...
                                                 <input type="text"  dir="rtl" autocomplete="off" class="form-control"  placeholder="VAT Number (Arabic)" id="svendor_no1<?php echo $i;?>" name="svendor_no1[]" value="<?php echo $sclient_vat_arabic[$i]; ?>">
                                         ...
                                         <div class="col-md-4">
                                            ...
                                            <div class="row">
                                              ...
                                              <label id="location-error" class="validation-error-label" for="location"><?php echo form_error('district_arabic['.$i.']'); ?></label>
                                              </div>
                                              </div>
                                                <div class="col-md-4" style="margin-top: -15px;">
                                            ...
                                            <div class="row">
                                               <div class="col-md-4" style="margin-top: -15px;">
                                                ...
                                                <div class="form-group <?php if(form_error('szip_arabic['.$i.']')){ echo 'has-error'; }?>">
                                                  <input type="text" dir="rtl" class="form-control " name="szip_arabic[]" autocomplete="off" id="szip_arabic<?php echo $i;?>" placeholder="Zip (Arabic) " value="<?php echo $zip_arabic[$i];?>" >
   ...
   function getConfirmPart(inv, prid)
  {
      ...
      if(prid!='' && r==true)
      {
        $.ajax(
        {
          "url":"<?php echo site_url('masters/Client/deleteshipAddress'); ?>",
          "type":"GET",
          data:{"prid":prid},
