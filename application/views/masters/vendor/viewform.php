                    ...
                    <div class="page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                         ...
                         <div class="col-md-6" align="right">
                                      <a href="<?php echo base_url().'masters/Vendor/add_vendor';?>" style="text-align: right;" class="btn btn-primary ">Add New Supplier</a>
                                  </div>
                    </div>
                    </div>
                </div>
...
<script type="text/javascript">
     function AssignClient(id,status)
          {
             $.ajax({
                type: "GET",
                url: "<?php echo site_url('masters/Vendor/AssignClient'); ?>", 
