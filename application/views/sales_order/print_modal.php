...
<div class="modal-content" id="tt" >
  <div class="modal-header">
    <h3 class="modal-title" id="exampleModalCenterTitle"><b><?php echo"Print Invoice";?></b></h3>
  ...
  <form ng-app="form-example" method="post" id="ajaxModelForm" enctype="multipart/form-data" action="javascript:" ui-jp="parsley">
    ...
    <div class="row">
      ...
      <a href="<?php echo base_url()?>/sales_order/printSalesorder/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-primary"> Print Without Header</a>
      <a href="<?php echo base_url()?>/sales_order/printSalesorder1/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-info">Print With Header</a>
