<?php 
  ...
  foreach($bank_detail->result() as $row)
  {
    ...
    $bank_curency =$row->bank_curency;
      $branch_name             = $row->branch_name;
     
  }
$currency_name=$this->pre->get_currency_name($bank_curency );
  $currency_iso=$this->pre->get_currency_iso($bank_curency );
?>
<style>
.break
 { 
...
<table style="width: 100%"  border="0" cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td style="width: 80%; line-height: 30px;vertical-align: middle;text-align: left;font-size: 22px;font-family: Algerian" ><b>INVOICE</b></td>
...
<table>
  <tr>
    <td style="width: 51%;border-top: 2px solid green;border-right: 2px solid green;border-left: 2px solid green;"></td>
    <td style="width: 2%;"></td>
     <td style="width: 47%;border-top: 2px solid green;border-right: 2px solid green;border-left: 2px solid green;"></td>
  </tr>
<tr>
  <td style="width: 4%;border-left: 2px solid green;border-bottom: 2px solid green;"></td>
  <td style="width: 46%;border-bottom: 2px solid green;text-align: center;font-size: 14px;"><b>Standard Terms & Conditions:</b><span style="font-size: 12px;text-align: left"><?php echo $general_terms;?></span></td>
  <td style="width: 1%;border-bottom: 2px solid green;border-right: 2px solid green"></td>
  <td style="width: 2%;"></td>

   <td style="width: 2%;border-left: 2px solid green;border-bottom: 2px solid green;"></td>
  <td style="width: 45%;border-bottom: 2px solid green;border-right: 2px solid green;text-align: center;font-size: 14px;"><b>Bank Details:</b><br><br>
<span style="font-size: 12px;text-align: left">Account Name&nbsp;:&nbsp;AGM Technical Solutions Co. WLL<br>IBAN No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo  $iban_no ;?> <br>SWIFT Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo  $swift_code;?><br>Bank Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $bank_name;?><br>Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo $branch_name;?><br>Currency&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $currency_name; echo "("; echo $currency_iso  ; echo")";?><br> </span>
  </td>
</tr>
</table>
