<div class="row allrowvalues" id="rowssids_<?php echo $i;?>">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			echo form_dropdown('pro_item_id[]', $drop_menu_product_item, set_value('pro_item_id['.$i.']', (isset($pro_item_id)) ? $pro_item_id : ''), $attrib);
			?>
			...
			<input type="hidden" name="barcode[]" id="barcode<?php echo $i;?>">
		</div>
	</div>
