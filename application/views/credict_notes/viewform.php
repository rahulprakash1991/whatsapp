                    ...
                    <div class="page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                         ...
                         <div class="col-md-6" align="right">
                                      <a href="<?php echo base_url().'Credict_notes/add_credict_notes';?>" style="text-align: right;" class="btn btn-primary ">Add New Credit Note</a>
                                  </div>
                    </div>
                    </div>
                </div>
...
<script type="text/javascript">
          function addprintModal(id)
          {

            $.ajax({
              type: "GET",
              url: "<?php echo site_url('Credict_notes/PrintModal'); ?>",
              data: {invoice_id:id},
              dataType:"html",
              success: function(response)
              {
