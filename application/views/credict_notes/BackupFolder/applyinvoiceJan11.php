    ...
    <div class="modal-body">
      ...
      <div class="row">
          <div class="col-sm-12 col-xs-12">
              <span  style="text-align: right;vertical-align: bottom;margin-left: 1200px;"><b>Balance:<?php echo $credit_balance;?></b></span> 
          </div>
        </div>
        <hr>
   <?php 
  ...
  <?php $i++; }?>
     ...
     <div class="col-sm-4 col-xs-4"align="right">
       <div class="row">
        ...
        <div class="col-sm-3 col-xs-3">
          <input type="text" class="form-control"  id="add_amount" name="add_amount" value="" autocomplete="off" readonly  >
        </div>
       </div>
 ...
 <div class="row">
     ...
     <div class="col-sm-4 col-xs-4"align="right">
       <div class="row">
        ...
        <div class="col-sm-3 col-xs-3">
          <input type="text" class="form-control"  id="credit_bal" name="credit_bal" value="<?php echo $credit_balance;?>" autocomplete="off" readonly  >
        </div>
       </div>
    ...
    <div class="row">
      ...
      <button type="submit" class="btn btn-primary"><?php echo "Apply";?></button>&nbsp;&nbsp;
...
{
  apply_amount =  $('#amount_crt'+row+'').val();
  add_amount =  $('#add_amount').val();
  credit_amount_bal =  $('#credit_bal').val();
  // if(apply_amount>credit_amount_bal)
  // {
