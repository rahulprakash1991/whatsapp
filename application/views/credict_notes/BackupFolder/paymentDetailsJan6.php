                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <h1 style="margin-top:0;"><strong>Credict Note</strong> #<?php echo $credit_no;?></h1>
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            if($credit_balance_amount==0){?>
                                                <div class="label label-success" role="button">Closed</div>
                                            <?php }else {?>
                                                <div class="label label-danger" role="button">Open</div>
                                            <?php }?>
                                        </td>
                                    </tr>
                                 </table>   
