                                 ...
                                 <div class="row allrowvalues"  id="rowssids_<?php echo $i;?>"  style="margin-left: 10px;">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group <?PHP if(form_error('qty[]')){ echo 'has-error';} ?>">
                                            ...
                                            <input name="qty[]" autocomplete="off" class="form-control qty" id="qty<?php echo $i;?>" type="text" value="<?php echo $qty[$i]; ?>" onkeyup="calculateqty();"   placeholder=" Qty"  />
 ...
 -->					                                         </div>
                                   	...
                                   	<div class="row">
        								<div class="text-center">
					                      ...
					                      <button type="submit" name="Submit" class="btn btn-primary"><?php echo ($credict_id!='' ? 'Update Credict Note' : 'Create Credict Note'); ?> </button>
