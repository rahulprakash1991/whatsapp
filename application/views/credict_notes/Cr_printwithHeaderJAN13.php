...
<table style="width: 100%;border-color:#000;table-layout: fixed; " rules="all" border="1"  >
    ...
    <td class="no-border" colspan="100">
        <img src="<?php echo base_url('img/logo/header.jpeg')?>" width="100%" style="height:70px;">
    </td>
    </tr>
  </thead>
<tbody>
  <tr>
   ...
   <tr style="height:20px;">
    ...
    <tr>
    <td class="no-border"  colspan="50" style="font-size: 16px;text-align: left;width: 50%;"  ><strong>Credit No  : <?php echo $credit_no;?></strong></td>
    <td class="no-border"  colspan="50" style="font-size: 16px;text-align: right;width: 50%;"><strong>Invoice No : <?php echo $sal_order;?></strong></td>
  </tr>
   <tr>
    <td class="no-border"  colspan="50" style="font-size: 16px;text-align: left;width: 50%;"  ><strong>Credit Date  : <?php echo date('d/m/Y', strtotime($credit_date));?></strong></td>
    <td class="no-border"  colspan="50" style="font-size: 16px;text-align: right;width: 50%;"><strong>Invoice Date : <?php echo date('d/m/Y', strtotime($sal_order_date));?></strong></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="35" style="font-size: 12px;width: 35%;vertical-align: top;" class="no-border-bottom_right_left1"><?php echo $client_address; echo " "; echo $client_street; echo" "; echo $client_district;echo " ";echo  $client_province ;echo " ";echo  $client_zip ;echo" ";echo  $client_area ;echo" ";echo  $client_country ;  ?></td>
    <td colspan="38" style="font-size: 12px; text-align:right;width: 38%;vertical-align: top;" class="no-border-bottom_right_left1"><?php echo $client_address_arabic; echo " "; echo $street_arabic; echo" "; echo $client_district_arabic;echo " ";echo  $client_province_arabic ;echo " ";echo  $client_zip_arabic ;echo" ";echo  $client_area_arabic ;echo" ";echo  $client_country_arabic ;  ?> </td>
 ...
 <tr style="height:10px;">
  ...
  <tfoot >
     <tr height="60px">
             ...
             <img src="<?php echo base_url('img/logo/footer.jpeg')?>" width="100%" style="height:70px;">
                    </td>
                </tr>
