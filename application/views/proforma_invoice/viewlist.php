				...
				<div class="page-title">
					...
					<div class="page-breadcrumb">
					   ...
					   <div class="col-md-6" align="right">
                                      <a href="<?php echo base_url().'Proforma';?>" style="text-align: right;" class="btn btn-primary "><?php echo 'Add New Proforma'?></a>
                                  </div>
                              </div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-white">
								...
								<form  method="POST" action="<?php echo base_url();?>Proforma/manage"> 
									<div class="col-md-2">
									...
									<div class="form-group <?PHP if(form_error('to_date')){ echo 'has-error';} ?>">
										...
										<select name="inv_status" id="inv_status" class="form-control" >
											<option value="">-- Select --</option>
                                       		<option value="1" <?php if($inv_status== '1'){ echo "selected";}?>>Closed</option>
                                        	
                                          	<option value="0" <?php if($inv_status== '0'){ echo "selected";}?>>Open</option>
										</select>										
                                    </div>
								</div>
									<div class="col-md-1">
...
<script type="text/javascript">
          function addrepModal(id)
          {
            ...
            $.ajax({
              type: "GET",
              url: "<?php echo site_url('Proforma/addClientRep'); ?>",
              data: {invoice_id:id},
              dataType:"html",
