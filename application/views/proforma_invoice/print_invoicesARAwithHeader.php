...
// decimal
 ...
 <tr style="height:10px;">
    ...
    <tr style="height: 20px;">
    <td  colspan="40"style="font-size: 10px;text-align: center;width: 35%;"><b><?php echo $bname ;?></b></td>
    <td colspan="16"  style="font-size: 10px;text-align: center;width: 19%;"><b><?php echo $account_no;?></b></td>
    <td colspan="22" style="font-size: 10px;text-align: center;width: 22%;"><b><?php echo $iban_no;?></b></td>
    <td colspan="22" style="font-size: 10px;text-align: center;width: 24%;"><b><?php echo $bank_name;?></b></td>
  </tr> 
  <tr style="height:30px;">
    <td class="no-border"  colspan="100" style="width: 100%;"></td>
    </tr>
