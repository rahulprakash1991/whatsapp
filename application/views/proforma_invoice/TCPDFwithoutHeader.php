...
<table style="width: 100%"  border="0" cellpadding="1" cellspacing="0"  >
  ...
  <tr>
    <td   colspan="100" style="font-size: 18px;text-align: center;width: 100%; "><br><br><b><u>PROFORMA - INVOICE /  الفاتورة الأولية </u></b>  </td>
  </tr>
  ...
  <tr >
    ...
    <td colspan="10"  style="font-size: 10px;width: 10%;vertical-align: middle;text-align: right;border-top:0.1px solid black;border-right:0.1px solid black;"  >إلى  </td>
   ...
   <!--  <td colspan="38" style="font-size: 8px;width: 38%;vertical-align: top;" ><?php echo $client_address; echo " "; echo $client_street; echo" "; echo $client_district;echo " ";echo  $client_province ;echo " ";echo  $client_zip ;echo" ";echo  $client_area ;echo" ";echo  $client_country ;  ?></td>
    ...
    <td colspan="10" style="font-size: 10px;width: 10%;vertical-align: top;text-align: right;border-right:0.1px solid black;" >العنوان  </td>
...
$co_no_arabic_letter= strtr($contact_no_arabic_eng, ['٠','١','٢','٣','٤','٥','٦','٧','٨','٩']);?>
    ...
    <td colspan="1"  style="font-size: 10px;text-align: center;width: 1%;vertical-align: top;" >:</td>
    <td colspan="10"   style="font-size: 10px;width: 10%;vertical-align: top;text-align: right;border-right:0.1px solid black;" >هاتف   </td>
...
$vat_no_arabic_letter= strtr($client_vat_arabic_eng, ['٠','١','٢','٣','٤','٥','٦','٧','٨','٩']);?>
    ...
    <td colspan="10"  style="font-size: 10px;width: 10%;vertical-align: top;text-align: right;border-bottom:0.1px solid black;border-right:0.1px solid black;" >الرقم الضريبي     </td>
  </tr>
</table>
<table style="width: 100%"  border="0" cellpadding="4" cellspacing="0"  >
  ...
  <tr style="height:50px;" >
    ...
    <td rowspan="2" colspan="41" style="font-size: 9px;text-align: center;width: 41%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b>DESCRIPTION  الوصف   </b> </td>
    <td colspan="6" style="font-size: 9px;text-align: center;width: 6%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> الوحده  </b></td>
    <td colspan="6" style="font-size: 9px;text-align: center;width: 6%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> الكمية. </b></td>
    <td colspan="9" style="font-size: 9px;text-align: center;width: 9%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> سعر الوحده  </b></td>
    <td colspan="9" style="font-size: 9px;text-align: center;width: 9%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> اجمالي المبلغ شامل الضريبة </b></td>
    <td colspan="6" style="font-size: 9px;text-align: center;width: 6%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> ضريبة  </b>   </td>
    <td colspan="9" style="font-size: 9px;text-align: center;width: 9%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b> مبلغ الضريبة  </b></td>
    <td colspan="10"style="font-size: 9px;text-align: center;width: 10%;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;"><b>قيمة الضريبة      </b></td>
   </tr>
    <tr>
  ...
  <td colspan="33"  style="font-size: 10px; text-align: right;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;width: 33%;vertical-align: middle;"><b> إجمالي المبلغ <br>Sub Total</b></td>
...
<tr>
  <td colspan="33" style="font-size: 10px;text-align: right;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;width: 33%;vertical-align: middle;"><b>15 ضريبة القيمة المضافة  <br>Value Added Tax 15%</b></td>
...
<tr>
  <td colspan="33" style="font-size: 10px;text-align: right;border-bottom:0.1px solid black;border-top:0.1px solid black;border-left:0.1px solid black;border-right:0.1px solid black;width: 33%;vertical-align: middle;"><b>المبلغ الإجمالي مع ضريبة القيمة  <br>Total Amount With VAT</b></td>
