...
<div class="modal-content" id="tt" >
  <div class="modal-header">
    <h3 class="modal-title" id="exampleModalCenterTitle"><b><?php echo"Print Proforma Invoice";?></b></h3>
  ...
  <form ng-app="form-example" method="post" id="ajaxModelForm" enctype="multipart/form-data" action="javascript:" ui-jp="parsley">
    ...
    <div class="row">
      ...
      <a href="<?php echo base_url()?>/Proforma/printSalesorder/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-primary"> Print Without  Header</a>
      <a href="<?php echo base_url()?>/Proforma/printSalesorder1/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-info">Print With Header</a>
