...
foreach($value->result() as $row)
{
	...
	$payment_status         	= $row->per_payment_status;
	...
	$paid_amount              	= $row->per_paid_amount;
...
<div class="page-inner">
    ...
    <div class="page-title">
        <div class="pull-right">         
            <a href="<?php echo base_url();?>Proforma/manage" class="btn btn-info">
            ...
            <a class="btn btn-primary" href="<?php echo base_url();?>Proforma/printSalesorder/<?php echo $sal_id;?>" class="btn btn-default" target="_blank">
                <i class="fa fa-print m-r-xs"></i>Print
            </a>    
            <?php if($sal_invoice_status!=1){?>
            <a class="btn btn-success" href="#" class="btn btn-default"  onclick="alertMsg(<?php echo $sal_id;?>,<?php echo $sal_invoice_status;?>)">
                <i class="fa fa-save m-r-xs"></i>Save As Invoice
            </a> 
            <?php }?>                                     
        </div>
        <h3>Proforma</h3>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <h1 style="margin-top:0;">PROFORMA #  <strong><?php echo "  "; echo $sal_order;?> </strong></h1>
                                ...
                                <table class="table table-striped">
                                    <tr>
                                        ...
                                        <td><strong>Proforma Status</strong>
                                        <?php 
                            ...
                            <div class="col-md-6">
                             <div class="panel panel-white">
                                <div class="text-right">
                                    ...
                                    <h1 class="no-m text-success"><?php echo $getCurrency;?> <?php echo number_format((float)$sal_sub_total , 2, '.', '');?></h1>
                            ...
                            <div class="col-md-6">
                             <div class="panel panel-white">
                                <div class="text-right">
                                    ...
                                    <h1 class="no-m text-success"><?php echo $getCurrency;?> <?php echo number_format((float)$sal_tax_amount , 2, '.', '');?></h1>
...
function alertMsg(id) {
        ...
        var x;
        var r=confirm("Are You Sure You Want to move this proforma to Invoice?!!");
        if(id!='' && r==true )
        {
              $.ajax({"url":"<?php echo site_url('Proforma/ApplyToInvoice'); ?>",
              "type":"POST",
              data:{
                  "id":id
              },
              ...
              success:function(data)
                {
                    // alert(data);
                     setTimeout("window.location = '<?php echo site_url('Sales_order/manage'); ?>'",100);
                }
