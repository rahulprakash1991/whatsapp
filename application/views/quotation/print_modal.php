...
<div class="modal-content" id="tt" >
  ...
  <form ng-app="form-example" method="post" id="ajaxModelForm" enctype="multipart/form-data" action="javascript:" ui-jp="parsley">
    ...
    <div class="row">
      ...
      <a href="<?php echo base_url()?>/Quotation/printSalesorder/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-primary"> Print Without Header</a>
      <a href="<?php echo base_url()?>/Quotation/printSalesorder1/<?php echo $id;?>" target="_blank" title="Print" class="btn btn-info">Print With Header</a>
