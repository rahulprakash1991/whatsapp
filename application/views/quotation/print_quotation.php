...
<hr />
<h1 align="right">QUOTATION</h1>         
<table width="100%" cellspacing="5" cellpadding="5" border="1" rules="all">
    <tr>
        <td colspan="6" rowspan="3" class="br_none_l" style="width:66%">
           <strong>To : </strong></br>
        ...
        <td colspan="3">
           <strong>Quotation No. : </strong><h3 style="margin:0;"><?php echo $quo_order;?></h3>
        </td>
    </tr>
    <tr>
        <td colspan="3">
           <strong>Quotation Date : </strong><?php echo date('d/m/Y', strtotime($quo_date));?>
        </td>
    </tr>
</table>
<table width="100%" cellspacing="5" cellpadding="5" border="1" rules="all">
    ...
    <tr>
        ...
        <td class="br_none_t br_none_b" align="right">
        	<strong><?php echo $getCurrency;?></i> <?php echo $quo_sub_total ;?></strong>
        </td>
    </tr>
	<?php 
	if($quo_discount > 0)
    {
        ...
        <tr>
            ...
            <td class="br_none_t br_none_b"></td>
            <td class="br_none_t br_none_b" align="right">
            	<strong><?php echo $getCurrency;?></i> <?php echo number_format((float)$quo_discount, 2, '.', '');?></strong>
            </td>
        </tr>
    <?php
    }
	?>
	<?php  
    foreach($quotation_tax as $key =>$row)
    {
		if($row->quo_tax_amount > 0)
		{ 
		  ?> 
            <tr>
                <td class="br_none_t br_none_b"></td>
                ...
                <td class="br_none_t br_none_b"></td>
                <td class="br_none_t br_none_b" align="right">
                	<strong><?php echo $getCurrency;?></i> <?php echo $row->quo_tax_amount;?></strong>
                </td>
            </tr>
		<?php 
		}
	...
	if($quo_delivery_amount > 0)
    {
        ...
        <tr>
            ...
            <td class="br_none_t br_none_b"></td>
            <td class="br_none_t br_none_b" align="right">
            	<strong><?php echo $getCurrency;?></i> <?php echo number_format($quo_delivery_amount, 2, '.', '');?></strong>
            </td>
        </tr>
    <?php
    }
