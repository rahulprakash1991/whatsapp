      ...
      &:empty {
        &:before {
          margin-right: 0;
							...
							<div class="panel panel-white">
								...
								<div class="panel-body">
									...
									<div class="row">
				                        		...
				                        		<div class="form-group <?PHP if(form_error('vendor_rep')){ echo 'has-error';} ?>">
													<label>Client Representative</label>
				                               	 	...
				                               	 	// $drop_menu_address 	=	$CI->sal_common->drop_menu_vendor_rep($quotation_vendor);
				                               	 		// $drop_menu_address 	=	$CI->sal_common->drop_menu_client_rep($quotation_vendor);
				                     ...
				                     <!--  	<div class="col-md-3">
				                        	<div class="form-group">
				                        		<div class="form-group <?PHP if(form_error('quotation_num')){ echo 'has-error';} ?>">
													<label>Quotation No</label>
				                               	 	 <input name="quotation_num"  class="form-control " id="quotation_num" type="text" value="<?php echo $quotation_num; ?>" placeholder="Quotation No " readonly/> 
													 <label class="error"><?php echo form_error('quotation_num'); ?></label>
												</div>
				                    ...
				                    <div class="row">
				                      ...
				                      <!-- 	<div class="col-md-3">
				                        	<div class="form-group">
				                        		<div class="form-group <?PHP if(form_error('delivery')){ echo 'has-error';} ?>">
													<label>Delivery</label>
				                               	 	<?php 
				                               	 	$drop_menu_address1 	=	$CI->sal_common->drop_menu_vendor_address($quotation_vendor);
				                                	$attrib = 'class="bootstrap-select" data-live-search="true" data-width="100%" id="delivery" ';
													echo form_dropdown('delivery', $drop_menu_address1, set_value('vendor_rep', (isset($delivery)) ? $delivery : ''), $attrib);
													?>
												</div>
                                ...
                                <div class="row">
				                        ...
				                        <div class="col-md-4 text-right" >
 											...
 											<div class="row" style="padding-left: 10px;padding-right: 10px;">
                                   			...
                                   			<div class="row"  style="padding-left: 10px;padding-right: 10px;">
                                                  ...
                                                  <textarea id="support_maintenance" name="support_maintenance" autocomplete="off" class="form-control summernote" rows="4" ><?php echo $support_maintenance;?></textarea>
                                                  </div>
                                   				</div>
                                   					<div class="col-md-6">
                                   					<div class="form-group">
                                   	...
                                   	<div class="row">
        								<div class="text-center" style="margin-left: 25px;">
					                      ...
					                      <input type="hidden" name="enq_id" id="enq_id" value="<?php echo $enq_id;?>" />  
			...
			// 				$(o).find('.discount_amount',this).val(vat_amout);
			...
			// 				grandtotal+=Number(total_after_dis);
			...
			// 	grandtotal1 =parseFloat(total_include_vat).toFixed(2);
			// 	var Sub_total = Number(grandtotal) + Number(grand_discount_total);
			// 	var total_inc_vat = Number(grandtotal) + Number(grandvattotal);
			// 	$('#sub_t').val(Sub_total);
			// 	$('#vat_amount').val(grandvattotal);
			// 	$('#total').val(total_inc_vat);
