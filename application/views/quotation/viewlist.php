				...
				<div class="page-title">
					...
					<div class="page-breadcrumb">
					    ...
					    <div class="col-md-6" align="right">
                           <a href="<?php echo base_url().'Quotation';?>" style="text-align: right;" class="btn btn-primary "><?php echo 'Add New Quotation'?></a>
                       </div>
					</div>
					</div>
				</div>
...
<script type="text/javascript">
          function addrepModal(id)
          {
            ...
            $.ajax({
              type: "GET",
              url: "<?php echo site_url('Quotation/printModal'); ?>",
              data: {invoice_id:id},
              dataType:"html",
