												...
												<table border="0" cellpadding="0" cellspacing="0" style="width: 94%;margin: 0px 3px;"class="flexibleContainer">
													<tr>
														<td  align="center" valign="top" style="width: 29%;">
															...
															<h1 valign="right" style="text-align: center;color:#FFFFFF;">PROFORMA INVOICE</h1>
																	...
																	<td align="center" valign="top">
																		...
																		<table style="width: 100%;" cellspacing="5" cellpadding="5" border="1" rules="all">
																		    ...
																		    <tr>
																		        ...
																		        <td align="right"><i class="<?php echo $cur_symbol;?>"></i> <?php echo $amount;?></td>
																		    </tr>
																		    <?php
																		    }
																		    for ($j=$i; $j <= 15; $j++)
																		    ...
																		    ?>
																		        <tr>
																			        ...
																			        <td class="br_none_t br_none_b" align="right">
																			        	<strong><?php echo $getCurrency;?> <?php echo $pro_sub_total ;?></strong>
																			        </td>
																			    </tr>
																				<?php 
																				if($pro_discount > 0)
																			    {
																			        ...
																			        <tr>
																			            ...
																			            <td class="br_none_t br_none_b"></td>
																			            <td class="br_none_t br_none_b" align="right">
																			            	<strong><?php echo $getCurrency;?><?php echo number_format((float)$pro_discount, 2, '.', '');?></strong>
																			            </td>
																			        </tr>
																			    <?php
																			    }
																					...
																					{ 
																					  ?> 
																			            <tr>
																			                ...
																			                <td class="br_none_t br_none_b"></td>
																			                <td class="br_none_t br_none_b" align="right">
																			                	<strong><?php echo $getCurrency;?><?php echo $row->pro_tax_amount;?></strong>
																			                </td>
																			            </tr>
																					<?php 
																					}
																				...
																				if($pro_delivery_amount > 0)
																			    {
																			        ...
																			        <tr>
																			            ...
																			            <td class="br_none_t br_none_b"></td>
																			            <td class="br_none_t br_none_b" align="right">
																			            	<strong><?php echo $getCurrency;?><?php echo number_format($pro_delivery_amount, 2, '.', '');?></strong>
																			            </td>
																			        </tr>
																			    <?php
																			    }
