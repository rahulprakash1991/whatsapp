...
<?php 
  ...
  foreach($company_detail->result() as $row)
  {
      ...
      $org_created_on             = $row->org_created_on;
      $con_created_by             = $row->con_created_by;
      $con_created_on             = $row->con_created_on;
  ...
  {		
      ...
      $sal_tax_amount             = explode(',',$row->sal_tax_amount);
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:right;">Invoice</h1>
																		<h2 style="text-align:left;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#e1e1e1;line-height:135%;"><?php echo $org_name;?></h4></h2>
																	<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
															          ...
															          <?php echo $org_area;?><br />
															          <?php echo $org_city;?>,
															          <?php echo $org_state;?>,
															          <?php echo $org_pincode;?><br />
															          <?php echo $org_country;?><br />
															          Phone:<?php echo $org_phone;?><br />
															          Fax:<?php echo $org_fax;?><br />
															          Website:<?php echo $org_website;?><br />
																...
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;"></br>To</h3>
																	...
																	<td align="right" valign="middle" class="flexibleContainerBox">
																		<table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Delivery At</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																					<address>
													            								 <?php 
																					              if($sal_customer_address!='')
																					              {
																					              ?>
																					                <?php 
																					                echo $sal_customer_address;
																					                ?>
																					                <?php
																					               }
																					              else
																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																						...
																						<table width="100%" cellpadding="10" border="1" rules="all">
																						...
																						<?php }?>
																						<tr>
																						<td colspan="3">Terms and Conditions:<br/>
																				      ...
																				      <td colspan="3">
																				          <table width="100%" cellspacing="5" cellpadding="5">
																				                 ...
																				                 <tr>
																				                      ...
																				                      <td><strong><?php echo $sal_sub_total;?></strong>
																				                      </td>
																				                 </tr>
																				                  <?php if($sal_discount!=0)
																				                   {?>
																				                   <tr>
																				                  
																				                      <td><strong>Discount</strong>
																				                      </td>
																				                      <td><strong><?php echo $sal_discount;?></strong>
																				                      </td>
																				                   </tr>
																				                   <?php
																				                   }?>
																				                    <?php 
																				                      ...
																				                      foreach($sales_order_tax as$key => $rows)
																				                      {
																				                        $sal_tax_amount      = $rows->sal_tax_amount;
																				                        $tax_name      = $rows->tax_name;
																				                            if($sal_tax_amount !='0')
																				                            {
																				                      ?>
																				                   ...
																				                   {?>
																				                      <tr>
																				                         <td><strong>Delivery Amount</strong></td>
																				                         <td><strong><?php echo $sal_delivery_amount;?></strong></td>
																				                      </tr>
																				                      <?}?>
																				                      <tr>
																				                          <td><strong>Total</strong></td>
																				                          <td><strong><?php echo $sal_grand_total;?></strong></td>
																				                          <td>&nbsp;</td>
																				                      </tr>
																				             </table>
																				      </td>
