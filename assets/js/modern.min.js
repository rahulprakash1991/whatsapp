$(document).ready(function() {
    ...
    var c = function() {
        ...
        a.attr("style", "min-height:" + o.height() + "px !important"), n.hasClass("page-sidebar-fixed") ? e = o.height() + s : (e = o.height() + s, e < $(window).height() && (e = $(window).height())), e >= a.height() && a.attr("style", "min-height:" + e + "px !important")
    };
    c(), window.onresize = c, $(".slimscroll").slimscroll({
        allowPageScroll: !0
    });
    var t = document.querySelector(".fixed-header-check"),
        i = document.querySelector(".fixed-sidebar-check"),
        l = document.querySelector(".horizontal-bar-check"),
        r = document.querySelector(".toggle-sidebar-check"),
        d = document.querySelector(".boxed-layout-check"),
        h = document.querySelector(".compact-menu-check"),
        u = document.querySelector(".hover-menu-check"),
        b = function() {
            $("body").hasClass("small-sidebar") && 1 == r.checked && r.click(), $("body").hasClass("page-header-fixed") || 0 != t.checked || t.click(), $("body").hasClass("page-sidebar-fixed") && 1 == i.checked && i.click(), $("body").hasClass("page-horizontal-bar") && 1 == l.checked && l.click(), $("body").hasClass("compact-menu") && 1 == h.checked && h.click(), $("body").hasClass("hover-menu") && 1 == u.checked && u.click(), $(".page-content").hasClass("container") && 1 == d.checked && d.click(), $(".theme-color").attr("href", "assets/css/themes/green.css"), c()
        },
        m = $(".navbar .logo-box a span").text(),
        p = m.slice(0, 1),
        g = function() {
            $("body").toggleClass("small-sidebar"), $(".navbar .logo-box a span").html($(".navbar .logo-box a span").text() == p ? m : p), c()
        },
        f = function() {
            $("body").hasClass("page-horizontal-bar") && $("body").hasClass("page-sidebar-fixed") && $("body").hasClass("page-header-fixed") && (i.click(), alert("Static header isn't compatible with fixed horizontal nav mode. Modern will set static mode on horizontal nav.")), $("body").toggleClass("page-header-fixed"), c()
        },
        k = function() {
            !$("body").hasClass("page-horizontal-bar") || $("body").hasClass("page-sidebar-fixed") || $("body").hasClass("page-header-fixed") || (t.click(), alert("Fixed horizontal nav isn't compatible with static header mode. Modern will set fixed mode on header.")), $("body").hasClass("hover-menu") && !$("body").hasClass("page-sidebar-fixed") && (u.click(), alert("Fixed sidebar isn't compatible with hover menu mode. Modern will set accordion mode on menu.")), $("body").toggleClass("page-sidebar-fixed"), $("body").hasClass(".page-sidebar-fixed") && $(".page-sidebar-inner").slimScroll({
                destroy: !0
            }), $(".page-sidebar-inner").slimScroll(), c()
        },
        y = function() {
            $(".sidebar").toggleClass("horizontal-bar"), $(".sidebar").toggleClass("page-sidebar"), $("body").toggleClass("page-horizontal-bar"), $("body").hasClass("page-sidebar-fixed") && !$("body").hasClass("page-header-fixed") && (t.click(), alert("Static header isn't compatible with fixed horizontal nav mode. Modern will set static mode on horizontal nav.")), c()
        },
        C = function() {
        ...
        x = function() {
            !$("body").hasClass("hover-menu") && $("body").hasClass("page-sidebar-fixed") && (i.click(), alert("Fixed sidebar isn't compatible with hover menu mode. Modern will set static mode on sidebar.")), $("body").toggleClass("hover-menu"), c()
        };
    if ($(".small-sidebar .navbar .logo-box a span").html($(".navbar .logo-box a span").text() == p ? m : p), $(".theme-settings").length || $(".sidebar-toggle").click(function() {
            g()
